...
@Autonomous(name = "Autozinho Blue Far", group = "Main")
public class autozinhoBlueFar extends OpMode {
    ...
    private final Pose intakePose = new Pose(-16, 6, Math.toRadians(88));
    private final Pose intakeEnd = new Pose(-16, 37, Math.toRadians(88));
    private final Pose intakeEndBack = new Pose(-16, 34, Math.toRadians(88));
