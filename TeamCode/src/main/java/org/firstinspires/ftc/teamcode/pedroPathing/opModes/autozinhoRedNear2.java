...
@Autonomous(name = "Autozinho Red Near 2", group = "Main")
public class autozinhoRedNear2 extends OpMode {
    ...
    private final Pose shootPose = new Pose(16, -4, Math.toRadians(-50));
